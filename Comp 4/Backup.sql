...
--
-- Host: localhost
-- Generation Time: Apr 16, 2015 at 08:01 PM
...
INSERT INTO `contact` VALUES(7, 'Gareth Nunns', 'garethnunns@gmail.com', 7, 'Demo', 'This is how it looks like when you''re contacted via the online form\r\n\r\nYou can leave the name and email fields blank if you want to remain anonymous', 1);
...
INSERT INTO `councillors` VALUES(1, 'Gareth Nunns', 'Gareth', 'me@garethnunns.com', '$2.Fkz1inLpkA', 10, 'IKL', 'Maths, Physics & Computing', 'As part of the media subcommittee, I take photos and videos of events and also develop the website, [find out more about me](http://garethnunns.com)', '/img/profiles/councillor1.jpg', 1, 0);
INSERT INTO `councillors` VALUES(2, 'Alice French', 'Alice', 'AF19745@hillsroad.ac.uk', '$2CW4AEzyrLWU', 1, 'ADC', 'English Lit, History, Maths, Japanese', 'As Chair I lead the committee on projects and help out the other officers with anything they need doing. I''m always happy to hear from students so email me with any suggestions/questions! \n', '/img/profiles/councillor2.jpg', 0, 0);
...
INSERT INTO `councillors` VALUES(5, 'Alex Moor', 'Alex', 'AM120106@hillsroad.ac.uk', '$2qBISPodjFMA', 7, 'MAM', 'Double Maths, Physics, Chemistry, French', 'I am in charge of keeping track of NUS issues and acting upon them, so if you have any concerns or issues you would like to raise in these areas please feel free to email me!', '/img/profiles/councillor5.jpg', 0, 0);
INSERT INTO `councillors` VALUES(6, 'George Smith', 'George', 'georgedsmith.97@gmail.com', '$2sR8iKFO9kkc', 5, 'RZK', 'Biology,Chemistry and Maths', 'My job is to organize and create social events for the college students. Email me if you need me :) biggup', '/img/profiles/councillor.png', 0, 0);
...
INSERT INTO `councillors` VALUES(8, 'Dong Zheng', 'Dong', 'dz119324@hillsroad.ac.uk', '$2ve3zzKBDgAo', 3, 'ADC', 'Maths , Biology , History and Chemistry', 'In charge of taking minutes and recording agendas, as well as organising general meetings and Form Reps', '/img/profiles/councillor8.jpg', 0, 0);
...
INSERT INTO `councillors` VALUES(11, 'Lucy Williams', 'Lucy', 'LW119053@hillsroad.ac.uk', '$2zAhZf6TLYK.', 11, 'ADC', 'French, English Literature and History', 'My role is to look after the college site, whilst mitigating our effect on the environment', '/img/profiles/councillor11.jpg', 0, 0);
INSERT INTO `councillors` VALUES(12, 'Callum Delhoy', 'Callum', 'cd120100@hillsroad.ac.uk', '$22.MViW6kjR2', 12, 'ADC', 'English Literature, Politics and History', 'Email me if you wish to found a society and / or if you have any questions about pre-existing ones', '/img/profiles/councillor12.jpg', 0, 0);
...
INSERT INTO `faqs` VALUES(11, 'Can''t see my question here?', 'If we haven''t covered your question here, please feel free to [contact the student council](/contact) and we''ll usually reply within 12-hours with an answer!');
...
INSERT INTO `form_reps` VALUES(5, 'IKL', 1, 'Kirsty Jones', 'Chris Murphy');
INSERT INTO `form_reps` VALUES(6, 'IKL', 0, 'Laura Block', 'Aleesha Viswambaran');
INSERT INTO `form_reps` VALUES(7, 'IKL', 1, 'Gareth Nunns', 'Millie Clift');
INSERT INTO `form_reps` VALUES(8, 'IKL', 0, 'Pok Fong', 'Nathanael Clifton');
INSERT INTO `form_reps` VALUES(9, 'IKL', 1, 'Pran Tadikonda', 'Beth Elwood');
INSERT INTO `form_reps` VALUES(10, 'ICP', 1, 'Gemma Duma', 'Madalena Byrne Temudo De Castro (Maddie Castro)');
INSERT INTO `form_reps` VALUES(11, 'ICP', 0, 'Joshua Vaughan', 'Rachel Smit');
INSERT INTO `form_reps` VALUES(12, 'ICP', 1, 'Subha Kumar', 'Maddie Smith');
INSERT INTO `form_reps` VALUES(13, 'ICP', 0, 'Uvini Edirisinghe', 'Alice Stuart');
INSERT INTO `form_reps` VALUES(14, 'KXT', 1, 'Ben Dzialdowski', 'Oliver Frestle');
INSERT INTO `form_reps` VALUES(15, 'KXT', 1, 'Elliot Rose', 'Maddie Koesterman');
INSERT INTO `form_reps` VALUES(16, 'KXT', 0, 'Freddie Barnes', 'Tierre Pride');
INSERT INTO `form_reps` VALUES(17, 'KXT', 0, 'Kenza Camara', 'Serena Kundu');
INSERT INTO `form_reps` VALUES(18, 'KXT', 0, 'Sam Champion', 'Molly Magrath');
INSERT INTO `form_reps` VALUES(19, 'KXT', 1, 'Thomas Denney', 'Murray Lewis');
INSERT INTO `form_reps` VALUES(20, 'LKE', 0, 'Catherine Watson', 'Lily Church');
INSERT INTO `form_reps` VALUES(21, 'LKE', 1, 'Charlotte McGreavy', 'Lucy Baker');
INSERT INTO `form_reps` VALUES(22, 'LKE', 1, 'Edred Whittingham', 'Natasha Taylor');
INSERT INTO `form_reps` VALUES(23, 'LKE', 0, 'Lara Rudin', 'Philippa Witherspoon');
INSERT INTO `form_reps` VALUES(24, 'LKE', 0, 'Luke Todd', 'Jonny Marriage');
INSERT INTO `form_reps` VALUES(25, 'LKE', 1, 'Ollie Hastings', 'Shannon Dawson');
INSERT INTO `form_reps` VALUES(26, 'GGT', 1, 'Charlotte Tame', 'Daniel Boulton');
INSERT INTO `form_reps` VALUES(27, 'ADC', 1, 'Emily Chadwick', '');
INSERT INTO `form_reps` VALUES(28, 'ADC', 0, 'Georgina Trow', '');
INSERT INTO `form_reps` VALUES(29, 'ADC', 0, 'Jessica Barrett', 'Chloe Brown');
INSERT INTO `form_reps` VALUES(30, 'ADC', 1, 'Maddy Curry', '');
INSERT INTO `form_reps` VALUES(31, 'ADC', 1, 'Madeleine Shannon', 'Lydia White');
INSERT INTO `form_reps` VALUES(32, 'ADC', 0, 'Soman Nadim Iqbal', 'Natasha Sice');
INSERT INTO `form_reps` VALUES(33, 'LJR', 0, 'Arabella Kirby', 'Tom Mayer');
INSERT INTO `form_reps` VALUES(34, 'LJR', 1, 'Charlie Bashford', 'Douglas Robinson');
INSERT INTO `form_reps` VALUES(35, 'LJR', 1, 'Eleanor Grace', 'Patrick Mchugh');
INSERT INTO `form_reps` VALUES(36, 'LJR', 1, 'Tori Gibbons', 'Torin Cooper-Bennun');
INSERT INTO `form_reps` VALUES(37, 'IMD', 0, 'Alex Foulds', 'Anna Mcnally');
INSERT INTO `form_reps` VALUES(38, 'IMD', 0, 'Felicity Miles', 'Anna Jose');
INSERT INTO `form_reps` VALUES(39, 'IMD', 1, 'Grace Carter', 'Samuel Weinberger');
INSERT INTO `form_reps` VALUES(40, 'IMD', 0, 'Harry Griffin', 'Abi Rabbett');
INSERT INTO `form_reps` VALUES(41, 'IMD', 1, 'Lewis Manning', 'Lauren McQuillan');
INSERT INTO `form_reps` VALUES(42, 'IMD', 0, 'Yasmin Halliwell', 'Callum Bains');
INSERT INTO `form_reps` VALUES(43, 'VCH', 0, 'Adam Wright', 'Grace Sice');
INSERT INTO `form_reps` VALUES(44, 'VCH', 1, 'Alex Deloukas', 'Matthew Eastgate');
INSERT INTO `form_reps` VALUES(45, 'VCH', 0, 'Chiedza Lunga', 'Bea Underwood');
INSERT INTO `form_reps` VALUES(46, 'VCH', 1, 'Jamie Doorbar', '');
INSERT INTO `form_reps` VALUES(47, 'VCH', 0, 'Sam Ross', 'Raveen Dosanjh');
INSERT INTO `form_reps` VALUES(48, 'VCH', 1, 'Will Sampson', 'Jake Leech');
INSERT INTO `form_reps` VALUES(49, 'MAM', 1, 'Chloe Reid', 'Kerry Martin');
INSERT INTO `form_reps` VALUES(50, 'MAM', 0, 'Francesco Dernie', '');
INSERT INTO `form_reps` VALUES(51, 'MAM', 1, 'Olii Wilson', 'Darren D''Souza');
INSERT INTO `form_reps` VALUES(52, 'MAM', 0, 'Romaisa ESebaihia', 'Frances Conboy.');
INSERT INTO `form_reps` VALUES(53, 'MAM', 1, 'Sophia Brumann', 'Melissa Dicks');
INSERT INTO `form_reps` VALUES(54, 'PAI', 1, 'Anne-lucie Bugain', '');
INSERT INTO `form_reps` VALUES(55, 'PAI', 0, 'Charles Hull', 'Beth Bradley');
INSERT INTO `form_reps` VALUES(56, 'PAI', 1, 'Henry MacDonald', 'Hannah Mitchell');
INSERT INTO `form_reps` VALUES(57, 'PAI', 1, 'Mateusz Ochal', 'Maail Afaal');
INSERT INTO `form_reps` VALUES(58, 'PAI', 0, 'Vineeth (Vinnie) Joseph', 'Emma Jackson');
INSERT INTO `form_reps` VALUES(59, 'HJH', 0, 'Freya Lawrence', 'Lucy McCann');
INSERT INTO `form_reps` VALUES(60, 'HJH', 1, 'James Nowshadi', 'Laura Burgazzi');
INSERT INTO `form_reps` VALUES(61, 'HJH', 0, 'Matt Organ', 'Antonia Hamilton');
INSERT INTO `form_reps` VALUES(62, 'HJH', 0, 'Olivia Dakin Lunan', 'Hannah Foley');
INSERT INTO `form_reps` VALUES(63, 'HJH', 1, 'Sophie Cheal', 'Leon Coals');
INSERT INTO `form_reps` VALUES(64, 'HJH', 1, 'William Schimrigk Biagini', 'Chloe Neal');
INSERT INTO `form_reps` VALUES(65, 'RZK', 0, 'Hester Lee', 'Ed Hodson');
INSERT INTO `form_reps` VALUES(66, 'RZK', 0, 'Lucy Hodge', 'Gemma Galletley');
INSERT INTO `form_reps` VALUES(67, 'RZK', 1, 'Octavia Hailes', '');
INSERT INTO `form_reps` VALUES(68, 'RZK', 0, 'Rosanna Larter', 'Raj Khandaker');
INSERT INTO `form_reps` VALUES(69, 'DMA', 1, 'Abi Richardson', 'Eliza Asari Parbi');
INSERT INTO `form_reps` VALUES(70, 'DMA', 1, 'Jacob Pake', 'Charlie Hilton');
INSERT INTO `form_reps` VALUES(71, 'DMA', 0, 'James Blackshaw', 'Ellen Hinks');
INSERT INTO `form_reps` VALUES(72, 'DMA', 1, 'Jenny Heaton', 'Avril Roberts');
INSERT INTO `form_reps` VALUES(73, 'DMA', 0, 'Sean Irving', 'Alex Garland');
INSERT INTO `form_reps` VALUES(74, 'BBW', 0, 'Chris Whitehead', 'Nathan Makelana');
INSERT INTO `form_reps` VALUES(75, 'BBW', 0, 'Eleanor Gibbs', 'Ninah Nsubuga');
INSERT INTO `form_reps` VALUES(76, 'BBW', 1, 'Eleanor Hunt', '');
INSERT INTO `form_reps` VALUES(77, 'BBW', 0, 'Isobel Fitzsimmons', 'Lily Matthews');
INSERT INTO `form_reps` VALUES(78, 'BBW', 1, 'Jasmine Ceccarelli-Drewry', 'Alex McIntyre');
INSERT INTO `form_reps` VALUES(79, 'BBW', 0, 'Joshua Gregory-Barnes', '');
INSERT INTO `form_reps` VALUES(80, 'BBW', 0, 'Naomi Abayasekara', 'Sice Natasha');
INSERT INTO `form_reps` VALUES(81, 'BBW', 0, 'Richard Geng', 'James Stacey');
...
INSERT INTO `functions` VALUES(13, 'blog', 'Outputs the blog', 'outputBlog( ($_GET[''blog''] ? $_GET[''blog''] : 1) );');
INSERT INTO `functions` VALUES(14, 'currentPhoto', 'Output the current group photo', 'echo ''<img src="''.currentPhoto().''" />'';');
INSERT INTO `functions` VALUES(15, 'year(add)', 'Output the current year of the council, with the option of adding the number **add**', 'echo currentYear()+$add;');
...
INSERT INTO `gcb` VALUES(4, 'sidewriting', '<div id="hrscside">Hills Road Student Council {year()}-{year(1)}</div>');
...
INSERT INTO `pages` VALUES(2, '404', '404', 'Page not found :(', 'Page 404', '', '### Dang it\r\n\r\nYou''ve ended up here because the page you were looking for doesn''t exist or maybe hasn''t even been made yet. Hopefully we''ll get it fixed soon...\r\n\r\nGo back to the [home page](/) for now?', 'If you think you shouldn''t be seeing this page, *please* contact our webmaster', 1, 'The requested page could not be found', '', 1, 1);
...
INSERT INTO `pages` VALUES(18, 'blog', 'Blog', 'The latest news from the council', '', '', '{ blog }', 'The latest posts from the council and individual councillors to find out what they''ve been doing recently', NULL, 'The latest news from the council', '', 1, 1);
...
INSERT INTO `policies` VALUES(6, 11, 'The Girls'' toilets', 'We have worked with the caretakers to get the lock fixed in the girls'' toilets. All four of the hand-driers are also now working. Please contact Lucy if you see any more problems around the site', 100);
...
INSERT INTO `societies` VALUES(3, 'English', 'Cair Hogan', '', '');
INSERT INTO `societies` VALUES(4, 'Badminton', 'Kitty Palmer', '', '');
INSERT INTO `societies` VALUES(5, 'Hockey', 'Heidi Whitaker', '', '');
INSERT INTO `societies` VALUES(6, 'History', 'Ellie Gilbert', '', '');
INSERT INTO `societies` VALUES(7, 'Communist', 'Theo Philip', '', '');
INSERT INTO `societies` VALUES(8, 'Ultimate Frisbee', 'Luca Love', '', '');
INSERT INTO `societies` VALUES(9, 'Film Society', 'Jose Barret', '', '');
INSERT INTO `societies` VALUES(10, 'Student Lecture', 'Tristan Lancaster', '', '');
INSERT INTO `societies` VALUES(11, 'Biology, Chemistry, Medical, Chemistry', 'Hettie Stevens', '', '');
INSERT INTO `societies` VALUES(12, 'Rowing', 'Maddie Koesteman', '', '');
INSERT INTO `societies` VALUES(13, 'Dance', 'Melissa Griffiths', '', '');
INSERT INTO `societies` VALUES(14, 'Engineering', 'Maddie Roche', '', '');
INSERT INTO `societies` VALUES(15, 'Hills Road Political Union', 'Sebastian Sander Scholling', '', '');
INSERT INTO `societies` VALUES(16, 'Debating Society', 'Will Matlock & Emma Ring', '', '');
INSERT INTO `societies` VALUES(17, 'Economics, Bussiness, Accounting Society', 'Emma Ring', '', '');
INSERT INTO `societies` VALUES(18, 'Berlesque & Pole Dancing', 'Shannon Dawson', '', '');
INSERT INTO `societies` VALUES(19, 'History of Art', 'Rosin Ellison Balaam', '', '');
INSERT INTO `societies` VALUES(20, 'Maths (Mathsoc)', 'Anastasia Barnes', '', '');
INSERT INTO `societies` VALUES(21, 'Philosophy', 'Sam Elliot', '', '');
INSERT INTO `societies` VALUES(22, 'German Society', 'Fabian Ruthren', '', '');
INSERT INTO `societies` VALUES(23, 'Classics', 'Adam Priestly', '', '');
INSERT INTO `societies` VALUES(24, 'Christian Union', 'Hannah Seekings', '', '');
INSERT INTO `societies` VALUES(25, 'Chess', 'Sam Juniper, Zoe Slattery and Callum Delhoy', '', '');
INSERT INTO `societies` VALUES(26, 'Computer Science', 'Peter Noble & Matense Odial', '', '');
INSERT INTO `societies` VALUES(27, 'Fandom Society', 'Sarah Masureik', '', '');
INSERT INTO `societies` VALUES(28, 'French', 'Lizzy Barr', '', '');
INSERT INTO `societies` VALUES(29, 'Anime & Manga', 'Edward Gibbens', '', '');
INSERT INTO `societies` VALUES(30, 'Humanist', 'Katlin Thorton', '', '');
INSERT INTO `societies` VALUES(31, 'Writers Society', 'Becca Challis & Molly Gilroy', '', '');
INSERT INTO `societies` VALUES(32, 'Model UN', 'Emily Jerram', '', '');
INSERT INTO `societies` VALUES(33, 'The Phoenix', 'Darren D''Souza', '', '');
INSERT INTO `societies` VALUES(34, 'Geography (Geogsoc)', 'Jonah Balmford', '', '');
INSERT INTO `societies` VALUES(35, 'Rocket Science & Cosmology', 'Divgansh Manocke', '', '');
INSERT INTO `societies` VALUES(36, 'Physics', 'Gianamar Giovannetti-Shigh', '', '');
INSERT INTO `societies` VALUES(37, 'Music For All', 'Tim Weaving', '', '');
INSERT INTO `societies` VALUES(38, 'Robotics', 'Hope Shaw', 'hs119349', '');
INSERT INTO `societies` VALUES(39, 'Music Clubs', 'Kate Murdoch', '', '');
INSERT INTO `societies` VALUES(40, 'Fashion', 'Phoebe Hyde', '', '');
INSERT INTO `societies` VALUES(41, 'LGBT', 'Reed Goodbody & Madeleine Shannon', '', '');
INSERT INTO `societies` VALUES(42, 'Amnesty', 'Flora Snelson', '', '');
INSERT INTO `societies` VALUES(43, 'Tabletop Society', 'Thomas Windred', '', '');
INSERT INTO `societies` VALUES(44, 'Hills Road Conservatives', 'George Collison', '', '');
INSERT INTO `societies` VALUES(45, 'Hills Road Liberal Democrats', 'Callum Delhoy', '', '');
INSERT INTO `societies` VALUES(46, 'Hills Road Labour Society', 'Jack Kerwin', '', '');
