<?php
	...
	function messageCount($user) { // return the message count for that user
		global $dbh;
		return $dbh->query("SELECT COUNT(*) AS count 
							FROM contact 
							WHERE (assoc_councillor = $user
							OR assoc_councillor = 0)
							AND NOT complete")->fetch(PDO::FETCH_OBJ)->count;
	}
	...
	function markDownInstructions() {
		echo '
			...
			<p><b>Images:</b><br>
			![Description of image]('.currentPhoto().')<br>
			<img src="'.currentPhoto().'" alt="Description of image" /></p>';
	}
?>