		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="page-content hasaside">	        	
					...
					<?php echo messageCount($user).(messageCount($user)==1 ? ' message' : ' messages') ?>
					</a></p>
					...
					<p><a href="formrep.php">Manage form reps</a></p>

					<p><a href="policy.php">Manage policies</a></p>

					<p><a href="society.php">Manage societies</a></p>
