(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["myhrsfc"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      auto_join_text_ing: "we were",               // [string]   auto tense for present tense: "i was" surfing
